...
I started with a basic structure of the page and built it with a black and white accent. I really wanted to use the card UI, so I used it to display the CV page contents. 
...
## Good practice
To my best extent, I've tried to keep to a good and respected design language as much as possible and reduce code plagiarism as well as content plagiarism like icon and background files. Although all contents and the code used from external sources have been credited in this file.
...
## Thoughts
It took me a little more than a week or two after I started this project to see its completion. But if I had to put the number of hours, I would say 22 hours would be a close enough guess.
